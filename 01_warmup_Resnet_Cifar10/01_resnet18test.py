...
class ResNet(nn.Layer):
    def __init__(self, in_dim=64, num_c = 10):
        super().__init__()
        self.in_dim = in_dim
        # stem
        ...
        self.classifier = nn.Linear(512, num_c)
...
#    E:\Anaconda3\envs\paddleEnv\python.exe F:\research\TechResTools\researchwork\211115-ViT\paddlepaddle\code\01\main.py